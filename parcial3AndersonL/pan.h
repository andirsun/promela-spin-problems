...
#define PanSource	"client-server.pml"
...
#define _nstates7	7	/* c6 */
#define minseq7	109
#define maxseq7	114
#define _endstate7	6

#define _nstates6	7	/* c5 */
#define minseq6	103
#define maxseq6	108
#define _endstate6	6

#define _nstates5	12	/* c4 */
#define minseq5	92
#define maxseq5	102
#define _endstate5	11

#define _nstates4	12	/* c3 */
#define minseq4	81
#define maxseq4	91
#define _endstate4	11

#define _nstates3	12	/* c2 */
#define minseq3	70
#define maxseq3	80
#define _endstate3	11

#define _nstates2	7	/* c1 */
#define minseq2	64
#define maxseq2	69
#define _endstate2	6

#define _nstates1	38	/* Receptor */
#define minseq1	27
#define maxseq1	63
#define _endstate1	37

#define _nstates0	28	/* Emisor */
#define minseq0	0
#define maxseq0	26
...
typedef struct P1 { /* Receptor */
	...
	unsigned _priority : 8; /* 0..255 */
#endif
	unsigned bitrecibido : 1;
	unsigned bitanterior : 1;
	uchar x;
} P1;
#define Air1	(sizeof(P1) - Offsetof(P1, x) - 1*sizeof(uchar))

#define PEmisor	((P0 *)this)
typedef struct P0 { /* Emisor */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#else
	#define ACCEPT_LAB	9 /* user-defined accept labels */
#endif
#ifdef MEMCNT
	#ifdef MEMLIM
