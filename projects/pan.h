...
#define _nstates12	11	/* c9 */
#define minseq12	262
#define maxseq12	271
#define _endstate12	10

#define _nstates11	23	/* c8 */
#define minseq11	240
#define maxseq11	261
#define _endstate11	22

#define _nstates10	51	/* c7 */
#define minseq10	190
#define maxseq10	239
#define _endstate10	50

#define _nstates9	23	/* cg */
#define minseq9	168
#define maxseq9	189
#define _endstate9	22

#define _nstates8	14	/* c5 */
#define minseq8	155
#define maxseq8	167
#define _endstate8	13

#define _nstates7	14	/* c4 */
#define minseq7	142
#define maxseq7	154
#define _endstate7	13

#define _nstates6	11	/* c3 */
#define minseq6	132
#define maxseq6	141
#define _endstate6	10

#define _nstates5	11	/* c2 */
#define minseq5	122
#define maxseq5	131
#define _endstate5	10

#define _nstates4	11	/* c1 */
#define minseq4	112
#define maxseq4	121
#define _endstate4	10

#define _nstates3	11	/* c0 */
#define minseq3	102
#define maxseq3	111
...
#define _nstates1	67	/* eljuez */
#define minseq1	34
#define maxseq1	99
#define _endstate1	66

#define _nstates0	35	/* jugador */
#define minseq0	0
#define maxseq0	33
...
#define Peljuez	((P1 *)this)
typedef struct P1 { /* eljuez */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, b) - 1*sizeof(int))

#define Pjugador	((P0 *)this)
typedef struct P0 { /* jugador */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define _NP_	13
#define _nstates13	3 /* np_ */
#define _endstate13	2 /* np_ */

#define _start13	0 /* np_ */
#define _start12	6
#define _start11	5
#define _start10	5
#define _start9	5
...
#else
	#define ACCEPT_LAB	17 /* user-defined accept labels */
#endif
#ifdef MEMCNT
	#ifdef MEMLIM
