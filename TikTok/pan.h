...
#define _nstates9	58	/* c5 */
#define minseq9	123
#define maxseq9	179
#define _endstate9	57

#define _nstates8	26	/* c4 */
#define minseq8	98
#define maxseq8	122
#define _endstate8	25

#define _nstates7	21	/* c3 */
#define minseq7	78
#define maxseq7	97
#define _endstate7	20

#define _nstates6	11	/* cc */
#define minseq6	68
#define maxseq6	77
#define _endstate6	10

#define _nstates5	21	/* c1_3 */
#define minseq5	48
#define maxseq5	67
#define _endstate5	20

#define _nstates4	14	/* c1_1 */
#define minseq4	35
#define maxseq4	47
#define _endstate4	13

#define _nstates3	14	/* c1 */
#define minseq3	22
#define maxseq3	34
#define _endstate3	13

#define _nstates2	8	/* elTock */
#define minseq2	15
#define maxseq2	21
#define _endstate2	7

#define _nstates1	8	/* elTick */
#define minseq1	8
#define maxseq1	14
#define _endstate1	7

#define _nstates0	9	/* servidor */
#define minseq0	0
#define maxseq0	7
#define _endstate0	8
...
#define PelTock	((P2 *)this)
typedef struct P2 { /* elTock */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define PelTick	((P1 *)this)
typedef struct P1 { /* elTick */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Pservidor	((P0 *)this)
typedef struct P0 { /* servidor */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
